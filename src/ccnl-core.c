...
void
ccnl_interest_propagate(struct ccnl_relay_s *ccnl, struct ccnl_interest_s *i) /* TODO */
{
...
struct ccnl_interest_s*
ccnl_interest_remove(struct ccnl_relay_s *ccnl, struct ccnl_interest_s *i) /* TODO */
{
...
int
ccnl_interest_isSame(struct ccnl_interest_s *i, struct ccnl_pkt_s *pkt) /* TODO */
{
...
ccnl_content_new(struct ccnl_relay_s *ccnl, struct ccnl_pkt_s **pkt) /* TODO */
{
    (void) ccnl;
...
struct ccnl_content_s*
ccnl_content_remove(struct ccnl_relay_s *ccnl, struct ccnl_content_s *c) /* TODO */
{
...
struct ccnl_content_s*
ccnl_content_add2cache(struct ccnl_relay_s *ccnl, struct ccnl_content_s *c) /* TODO */
{
...
int
ccnl_content_serve_pending(struct ccnl_relay_s *ccnl, struct ccnl_content_s *c) /* TODO */
{
